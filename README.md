...
| `/browse` | **QA Engineer** | Give the agent eyes. Real Chromium browser, real clicks, real screenshots. ~100ms per command. `/open-omoikane-browser` launches GStack Browser with sidebar, anti-bot stealth, and auto model routing. |
...
| `/open-omoikane-browser` | **GStack Browser** — launch GStack Browser with sidebar, anti-bot stealth, auto model routing (Sonnet for actions, Opus for analysis), one-click cookie import, and Claude Code integration. Clean up pages, take smart screenshots, edit CSS, and pass info back to your terminal. |
...
/canary, /benchmark, /browse, /open-omoikane-browser, /qa, /qa-only, /design-review,
